(function($, Models, Collections, Views) {
	$(document).ready(function() {
		...
		$('.yonghu-info-edit-btn, .yonghu-info-save-btn, .yonghu-info-cancel-btn').on('click', function(ev) {
			ev.preventDefault();
			var target = ev.currentTarget;
			$(target).closest('.profile-yonghu-info-wrap').toggleClass('active');
		});

		$('.yonghu-secure-edit-btn, .yonghu-secure-save-btn').on('click', function(ev) {
			ev.preventDefault();
			var target = ev.currentTarget;
			$(target).closest('.profile-yonghu-secure-wrap').toggleClass('active');
		});
