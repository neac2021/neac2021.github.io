(function($, Models, Collections, Views) {
    $(document).ready(function() {
        ...
        /**
         * View more portfolios, projects worked of freelancer, projects posted of yonghu
         */
                    ...
                    if(data.success == true){
                        ...
                        switch (post_type){
                            ...
                            case 'project':
                                ...
                                tag_name = 'li';
                                className = 'bid-item';
                                template_loop = '#ae-yonghu-history-loop';
                                el_obj = '.author-project-list';
                                break;
        ...
        // EMployer
        AuthorYonghuHistoryItem = Views.PostItem.extend({
            tagName: 'li',
            className: 'bid-item',
            template: _.template($('#ae-yonghu-history-loop').html()),
            onItemBeforeRender: function() {
                //before render item
            },
            onItemRendered: function() {
        ...
        AuthorYonghuHistory = Views.ListPost.extend({
            tagName: 'li',
            itemView: AuthorYonghuHistoryItem,
            itemClass: 'bid-item'
        });
			...
			handleAuth: function(model, resp, jqXHR) {
				...
				if (resp.success) {
					...
					//action register
						...
						if( model.get('role') == "freelancer" || model.get('role') == "yonghu" ){
